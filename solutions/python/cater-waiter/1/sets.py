...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for a_category in categories:
        if dish_ingredients <= a_category:
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    non_appetizers = set(dishes).difference(appetizers)
    return list(non_appetizers)
    #pass
...
def singleton_ingredients(dishes, intersection):
    ...
    union_dishes = set()
    for dish in dishes:
        union_dishes = union_dishes | dish
    return union_dishes - intersection
    #pass
